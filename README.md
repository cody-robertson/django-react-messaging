...
- Create a copy of `config/settings/local.py.example`:  
...
- `workon config` or `source config-venv/bin/activate` depending on if you are using virtualenvwrapper or just virtualenv.
